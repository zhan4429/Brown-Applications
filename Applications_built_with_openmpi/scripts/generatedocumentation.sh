...
for foldername in ${listofmissingfolders[@]}; do
   ...
   mkdir -p /home/$USER/Brown-Applications/Applications_built_with_openmpi/source/$foldernameshortened
   ...
   for filename in ${listofmissingfiles[@]}; do
      ...
      outputfile="/home/$USER/Brown-Applications/Applications_built_with_openmpi/source/$foldernameshortened/$containername/$containername.rst"
      echo "output file: "$outputfile

      inputpathcontent=$(<$inputpath)  

      mkdir -p /home/$USER/Brown-Applications/Applications_built_with_openmpi/source/$foldernameshortened/$containername
      ...
      bellfile="/home/$USER/Bell_Application/Applications_built_with_openmpi/source/$foldernameshortened/$containername/$containername.rst"
