...
for filename in ${listofmissingfiles[@]}; do
   ...
   outputfile="/home/$USER/Brown-Applications/Core/source/$containername/$containername.rst"
   echo "output file: "$outputfile

   inputpathcontent=$(<$inputpath)  

   mkdir -p /home/$USER/Brown-Applications/Core/source/$containername
   ...
   bellfile="/home/$USER/Bell_Application/Core/source/$containername/$containername.rst"
