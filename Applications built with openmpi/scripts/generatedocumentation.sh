...
for foldername in ${listofmissingfolders[@]}; do
   ...
   echo "pwd: $PWD"
   cd "$workingdirectory"
   mkdir -p /home/$USER/Brown-Applications/Applications\ built\ with\ openmpi/source/$foldername
   ...
   for filename in ${listofmissingfiles[@]}; do
      ...
      outputfile="/home/$USER/Brown-Applications/Applications built with openmpi/source/$foldername/$containername/$containername.rst"
      echo "output file: "$outputfile

      inputpathcontent=$(<$inputpath)  

      mkdir -p /home/$USER/Brown-Applications/Applications\ built\ with\ openmpi/source/$foldername/$containername
      ...
      bellfile="/home/$USER/Bell_Application/Applications built with openmpi/source/$foldername/$containername/$containername.rst"
